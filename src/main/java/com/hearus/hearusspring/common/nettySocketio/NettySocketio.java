...
//        this.namespace.addEventListener("transcription", String.class, transcribe());
//        this.dataQueue = new LinkedBlockingQueue<>();
//    }
//
//    // TODO : byte[].class 형태로 Vue에서의 요청 처리
//    private DataListener<String> transcribe() {
//        log.info("[NettySocketio]-[onReceived]-[{}] Received Audio Data");
//        return (client, data, ackSender) -> {
//            try {
//                log.info("[NettySocketio]-[onReceived]-[{}] Received Audio Data", client.getSessionId().toString());
//
//                if (data == null) {
//                    log.error("[NettySocketio] Unexpected null data received from client: {}", client.getSessionId());
//                    return;
//                }
//
//                if (data != null) {
